...
##### Using each of the three selected editors, open the file for editing, edit the file by replacing the nickname with the "21 " string, close the file without saving the changes.
- Add screenshots to the report:
